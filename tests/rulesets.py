...
REWRITE_DEPS = set(
    [(REWRITE_RULESET[0], REWRITE_RULESET[3], False),
     ...
     (REWRITE_RULESET[4], REWRITE_RULESET[9], True),  # Not reachable
     ...
     (REWRITE_RULESET[8], REWRITE_RULESET[12], True),  # Not reachable
     (REWRITE_RULESET[9], REWRITE_RULESET[11], False),
     (REWRITE_RULESET[9], REWRITE_RULESET[12], True),  # Not reachable
